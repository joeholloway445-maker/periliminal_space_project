...
const FRAMES: Array[Dictionary] = [
	...
	{id="crimson", name="Crimson Frame", type="light", stat_bonus={spd=10, pow=12, sty=6}, desc="Battle-red chassis, POW-forward design", lore="War frames from the old empire, repurposed for Neon Imperium combat circuits.", unlock_pow=300},
